...
public class Task3 {
    ...
    static int getCountOfGraphs(List<Integer> vertices) {
    ...
    static boolean tryAddToExistingGraph(Map<Integer, Set<Integer>> graphsMap,
    ...
    static void putNewSetWithDefInit(Map<Integer, Set<Integer>> graphsMap, int countOfGraphs,
                                     int vertex1, int vertex2) {
        Set<Integer> newSet = new HashSet<>();
        newSet.add(vertex1);
        newSet.add(vertex2);
        graphsMap.put(countOfGraphs, newSet);
    }
}
